...
public class OSProject_Part2 {
    ...
    public static int Quantum=20; //Quantum value is fixed, 10+ Group ID >> 10+10=20 
    ...
    public static void main(String[] args) throws FileNotFoundException {
        File infile = new File("inputnew1.txt");
        File output = new File("outputnew1_p2.txt");
